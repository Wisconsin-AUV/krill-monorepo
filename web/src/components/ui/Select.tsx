    ...
    >
      <HeadlessSelect
        ...
        className={clsx([
          ...
          // Disabled state
          'data-[disabled]:border-zinc-950/20 data-[disabled]:opacity-100 data-[disabled]:dark:border-white/15 data-[disabled]:dark:bg-white/[2.5%] dark:data-[hover]:data-[disabled]:border-white/15',
        ])}
      />
      {!multiple && (
