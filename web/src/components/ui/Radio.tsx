  ...
  return (
    ...
    >
      <span className={clsx([base, colors[color]])}>
        <span className="size-full rounded-full border-[4.5px] border-transparent bg-(--radio-indicator) bg-clip-padding forced-colors:border-[Canvas] forced-colors:group-data-checked:border-[Highlight]" />
      </span>
    </Headless.Radio>
  )
}
