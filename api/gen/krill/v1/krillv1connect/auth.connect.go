...
const (
	...
	AuthServiceName = "krill.v1.AuthService"
)
...
const (
	...
	AuthServiceGetSessionProcedure = "/krill.v1.AuthService/GetSession"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/krill.v1.AuthService/Login"
	// AuthServiceRegisterProcedure is the fully-qualified name of the AuthService's Register RPC.
	AuthServiceRegisterProcedure = "/krill.v1.AuthService/Register"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/krill.v1.AuthService/Logout"
	// AuthServiceUpdateProfileProcedure is the fully-qualified name of the AuthService's UpdateProfile
	// RPC.
	AuthServiceUpdateProfileProcedure = "/krill.v1.AuthService/UpdateProfile"
	// AuthServiceChangePasswordProcedure is the fully-qualified name of the AuthService's
	// ChangePassword RPC.
	AuthServiceChangePasswordProcedure = "/krill.v1.AuthService/ChangePassword"
)

// AuthServiceClient is a client for the krill.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the krill.v1.AuthService service. By default, it
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_krill_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// GetSession calls krill.v1.AuthService.GetSession.
...
// Login calls krill.v1.AuthService.Login.
...
// Register calls krill.v1.AuthService.Register.
...
// Logout calls krill.v1.AuthService.Logout.
...
// UpdateProfile calls krill.v1.AuthService.UpdateProfile.
...
// ChangePassword calls krill.v1.AuthService.ChangePassword.
...
// AuthServiceHandler is an implementation of the krill.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	authServiceChangePasswordHandler := connect.NewUnaryHandlerSimple(
		AuthServiceChangePasswordProcedure,
		svc.ChangePassword,
		connect.WithSchema(authServiceMethods.ByName("ChangePassword")),
		connect.WithHandlerOptions(opts...),
	)
	return "/krill.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) GetSession(context.Context, *v1.GetSessionRequest) (*v1.GetSessionResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.GetSession is not implemented"))
}

func (UnimplementedAuthServiceHandler) Login(context.Context, *v1.LoginRequest) (*v1.LoginResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.Login is not implemented"))
}

func (UnimplementedAuthServiceHandler) Register(context.Context, *v1.RegisterRequest) (*v1.RegisterResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.Register is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *v1.LogoutRequest) (*v1.LogoutResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.Logout is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) UpdateProfile(context.Context, *v1.UpdateProfileRequest) (*v1.UpdateProfileResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.UpdateProfile is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) ChangePassword(context.Context, *v1.ChangePasswordRequest) (*v1.ChangePasswordResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.AuthService.ChangePassword is not implemented"))
}
