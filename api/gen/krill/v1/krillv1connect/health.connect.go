...
const (
	...
	HealthServiceName = "krill.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/krill.v1.HealthService/Check"
)

// HealthServiceClient is a client for the krill.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *v1.CheckRequest) (*v1.CheckResponse, error)
}

// NewHealthServiceClient constructs a client for the krill.v1.HealthService service. By default, it
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_krill_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls krill.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the krill.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/krill.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *v1.CheckRequest) (*v1.CheckResponse, error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("krill.v1.HealthService.Check is not implemented"))
}
